...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.smartcalculator.xkmqpz"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
  ...
  signingConfigs {
    create("release") {
      ...
      keyAlias = System.getenv("KEY_ALIAS") ?: (if (selectedFile == releaseKeystore) "androidreleasekey" else "androiddebugkey")
